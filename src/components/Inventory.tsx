...
interface Character {
    ...
    onTool(uri: string): void;
}

function Inventory({ onCharacter, onTool }: Character) {
    const resources = [
        {
            name: "common_pickAxe",
    ...
    return (
        <>
            ...
            <CreateAssemblerConfig onCharacter={onCharacter} />
        </>
    );
}
